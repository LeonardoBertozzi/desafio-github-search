...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        ...
        btnConfirmar.setOnClickListener{
            val username = nomeUsuario.text.toString().trim()
    ...
    private fun saveUserLocal() {
        ...
        val sharepref = getSharedPreferences("git_prefs", MODE_PRIVATE)
        sharepref.edit()
    ...
    private fun showUserName() {
        ...
        val sharedpref = getSharedPreferences("git_prefs", MODE_PRIVATE)
    ...
    fun setupAdapter(list: List<Repository>) {
        ...
        adapter.carItemLister = {repository ->  openBrowser(repository.htmlUrl)}
